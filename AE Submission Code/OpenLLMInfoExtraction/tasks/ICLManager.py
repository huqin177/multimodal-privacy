...
class ICLManager:
    ...
    def __init__(self, config):
        ...
        self.icl_root = config["dataset_info"]["path"]
        self.icl_label_path = config["dataset_info"]["label_path"]
    ...
    def __prepare_icl_eamples(self):
        ...
        # Post-process the data for a better format.
        # self.icl_names = ['Lei Li', 'Chidiebere Kwame Nkrumah', 'Ethan Parker']
        ...
        # for name in self.icl_names:
        #     # self.icl_data[name] = open_txt(self.icl_root + '/' + name + '.txt')
        #     raw_list = open_txt(f'{self.icl_root}/{name}.html')
        #     raw = '\n'.join(raw_list)
